...
int main(int argc, char* argv[]) {
  ...
  bench_cute_lstm_cell<cutlass::half_t, TileShape<1, 1, 1>, /*Warp Arrangement*/
  ...
  bench_cute_lstm_cell<cutlass::half_t, TileShape<1, 2, 1>, /*Warp Arrangement*/
                       TileShape<16, 32, 32>,               /*CTA Shape*/
  ...
  bench_cute_lstm_cell<cutlass::half_t, TileShape<2, 2, 1>, /*Warp Arrangement*/
