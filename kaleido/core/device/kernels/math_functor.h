...
template <>
struct Exp<double> {
  __forceinline__ __host__ __device__ double operator()(const double& a) const {
    return exp(a);
  }
};
...
template <typename T>
struct Sub {
  __forceinline__ __host__ __device__ T operator()(const T a, const T b) const {
    return a - b;
  }
};
...
template <>
struct Div<double> {
  __forceinline__ __host__ __device__ double operator()(const double a,
...
template <typename T>
struct CellFunc {
  __forceinline__ __host__ __device__ T operator()(const T& f, const T& c,
                                                   const T& i,
                                                   const T& c_candidate) const {
